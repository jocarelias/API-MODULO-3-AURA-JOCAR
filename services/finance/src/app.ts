...
import { createFinancialStatusRouter } from './routes/financialStatus';
import { createAssessmentChargesRouter } from './routes/assessmentCharges';
...
export function createApp(): Express {
  ...
  app.use('/api/v1', createFinancialStatusRouter());
  app.use('/api/v1', createAssessmentChargesRouter());
