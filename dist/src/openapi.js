...
const evaluation_1 = require("./modules/schedules-assessments/domain/evaluation");
const calculationEngine_1 = require("./modules/schedules-assessments/domain/calculationEngine");
...
const calculationMethodEnum = calculationEngine_1.CALCULATION_METHOD_CODES;
...
const assessment = {
    ...
    properties: {
        ...
        teacherId: uuid,
        name: { type: 'string' },
        type: { type: 'string', enum: evaluation_1.EVALUATION_TYPES },
...
const assessmentBody = {
    ...
    properties: {
        ...
        description: { type: 'string', nullable: true },
        date: dateTime,
        maxScore: { type: 'number', exclusiveMinimum: 0, default: evaluation_1.EVALUATION_DEFAULT_MAX_SCORE },
...
const calculationComponentSchema = {
    type: 'object',
    required: ['weight'],
    properties: {
...
const calculationBreakdownSchema = {
    type: 'object',
    properties: {
        id: { type: 'string' },
        assessmentId: uuid,
...
const calculationMethodMetaSchema = {
    type: 'object',
    properties: {
...
function successEnvelope(items) {
    return {
        type: 'object',
        properties: {
            data: items,
...
function buildOpenApi() {
    return {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'API aberta para gestão de avaliações, notas, médias, horários, resultados e impressão de pautas/horários.',
        },
        paths: {
            ...
            '/api/v1/results/calculate': {
                post: {
                    ...
                    description: 'Motor multi-método: permite escolher entre média aritmética, ponderada percentual, soma percentual, média normalizada, cálculo por componentes ou cálculo personalizado.',
